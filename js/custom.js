...
---------------------------------------------------------------------------------------------*/
    ...
    function color_fill_header() {
        ...
        if(scroll >= 100) {
			...
			$(".header-style-4 .header-nav .nav > li > a").removeClass("item-bar");
			$(".header-style-4 .extra-nav > .extra-cell > div").removeClass("item-bar");
			console.log("removed...............")
			
			// $(".is-fixed").css("color", "black");
        } else {
            $(".is-fixed").removeClass("color-fill");
			$(".header-style-4 .header-nav .nav > li > a").addClass("item-bar");
			$(".header-style-4 .extra-nav > .extra-cell > div").addClass("item-bar");
        }
    }
